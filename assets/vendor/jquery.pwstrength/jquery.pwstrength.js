...
(function($) {
    $.pwstrength = function(password) {
        var score = 0,
            ...
            upperCase, lowerCase, digits, nonAlpha;
    ...
    $.fn.pwstrength = function(options) {
        var options = $.extend({
            ...
            texts: ['Very Weak', 'Weak', 'Medium Password <i class="zmdi zmdi-info"></i>', 'Acceptable Password <i class="zmdi zmdi-info"></i>', 'Very Strong']
        }, options || {});
