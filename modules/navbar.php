...
<html lang="en" style="" class=" js no-touch js no-touch csstransforms3d csstransitions">
 <head>
  ...
  <link rel="stylesheet" href="http://localhost/BLP-master/assets/css/navbar.css">
  <script type="text/javascript" src="http://localhost/BLP-master/assets/blp/jquery-1.11.1.min.js.download"></script>
<!-- stylesheet -->
...
<link href="http://localhost/BLP-master/assets/css/style.css" rel="stylesheet" type="text/css" media="all">
  <!-- header -->   
...
?>
            <li class="m_nav_item menu__item" id="moble_nav_item_6"> <a href="http://localhost/BLP-master/modules/login.php" class="menu__link"><i class="menu-icon fa fa-sign-in" aria-hidden="true"></i> Login </a> </li>
            <?php } ?>
        </nav>
          </ul>
      </div>
