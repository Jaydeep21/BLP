...
$result18 = mysqli_query($conn,"SELECT p.nerves,p.thickness,p.tenderness FROM `peripheral_nerves`AS p, `record` AS r WHERE pid=$id AND p.rid=r.rid ");
                ...
                <fieldset>
                    <div class="fieldset-content">
                                ...
                                <table style="padding-left: 34px ;margin-top: 9px;" id="tb7" class="tab orlist">
                                    ...
                                    <tbody>
                                         ...
                                         <tr style="padding: 2px;">
                                            ...
                                            <td><input type="text" name="Mi" class="valid" value=<?php echo $row20['mi']; ?>></td>
                                            <td><input type="text" name="Bi" class="valid" value=<?php echo $row20['bi']; ?>></td>
                                         </tr>
                                         <?php } ?>
                                    </tbody>
                            </table>
                         ...
                         <div class="form-textarea">
                            ...
                            <textarea name="Complaint" id="Complaint" placeholder="" value="" ><?php echo $row25['complaints']; ?></textarea>
                        </div>
                            ...
                            <label  class="form-label">Notes and Prescription</label>
                             ...
                             <table style="padding-left: 34px ;margin-top: 9px;" id="tb2" class="form-label">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><input type="date" name="date[]" class="valid" value=<?php echo $row25['due_date']; ?> ></td>
                                            <td><input type="text" name="clinical_notes[]" class="valid" value=<?php echo $row25['clinical_notes']; ?> ></td>
                                            <td><input type="text" name="prescription[]" class="valid"value=<?php echo $row25['prescription']; ?> ></td>
                            ...
                            <table style="padding-left: 34px ;margin-top: 9px;" id="tb4" class="form-label">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td><input type="text" name="appoinment_for[]" placeholder="Appoinment for..." value=<?php echo $row25['appointment_for']; ?> ></td>
                                          <td><input style="margin-left: 16px;" type="date" name="date_of_next_appoinment[]" value=<?php echo $row25['date_for_next_appointment']; }?> ></td>
